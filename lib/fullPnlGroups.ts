...
// "Open Locations" isn't a row here — it's reached via the Open Locations
// toggle (shown alongside the dropdown whenever 'all' or 'Consolidated' is
// selected), not as a directly clickable dropdown option.
